...
// Hoy ya no se va usa var, se utiliza let y const
let nombre2 ="Pedro";
console.log(nombre2);
...
let x, y; // Se pueden tener varias variable dentro de una misma línea
x = 17, y = 21; // Se puede hacer asignación de varias variables dentro de la misma línea
let z = x + y; // Se asgina el valor de la operación
console.log(z);
