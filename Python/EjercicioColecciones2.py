...
# 4 Lista de palabras que paarecen en ambas listas 
...
print(f"lista de platabras que aparecen en las listas: {union}")
print(f"lista de platabras que aparecen en las listas, pero no en la segunda: {solo1}")
print(f"lista de platabras que aparecen en las listas, pero no en la primera: {solo2}")
print(f"lista de platabras que aparecen en ambas listas: {interseccion}")
