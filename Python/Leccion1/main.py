...
miVariable=3
print(miVariable)
miVariable="Holaatodos los estudiantes de la tecnicatura"
print(miVariable)
miVariable = 3.5
print(miVariable)
x = 10
...
z = x + y
print(id(x))
# Las literales se escriben x528,la variableyx272,la variablez=x592
print(id(y))
print(id(z))
...
print (f"El residuo de la divisióhn es: {a % 2}")
if a % 2 == 0:
...
"""
# Ejercicio: Valor dentro de un ranto
valor = int(input("Digite un número dentro del rango 0 al 5: "))
valorMinimo = 0
valorMaximo = 5
dentroRango = valor >= valorMinimo and valor <= valorMaximo
if dentroRango:
    print(f"El valor {valor} esta dentro del rago")
else:
    print(f"El valor {valor} No esta dentro del rago")
"""
...
if (20 <= edad < 30) or (30 <= edad < 40): # Sintaxis simplificada del operador 
